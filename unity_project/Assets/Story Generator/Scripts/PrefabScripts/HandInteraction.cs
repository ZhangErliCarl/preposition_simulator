...
namespace StoryGenerator.CharInteraction
{
    public class HandInteraction : MonoBehaviour
    {
        ...
        public GameObject invisibleCpy {get;  set;}
        ...
        static readonly string[] HAND_POSE_PATHS = {"Chars/HandPoses/Male1/", "Chars/HandPoses/Mixamo/", "Chars/HandPoses/Teacher/" };
            ...
            if (isThisOriginal)
                    {
                        ...
                        if (invisibleCpy == null)
                        {
                            ...
                            Debug.Log(invisibleCpy.name);
                            //invisibleCpy.GetComponent<MeshRenderer>().enabled = false;
